      ...
      <div className="bg-bg-card shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div>
            ...
            <p className="text-tx-secondary mt-1">Manage your tenancy and payments</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="text-2xl font-bold text-tx-primary">{stat.value}</p>
            </Link>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-tx-primary">Recent Payments</h2>
              <Link
            ...
            {recentPayments.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-tx-secondary">No payment history yet</p>
              </div>
            ) : (
          ...
          <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-tx-primary">Maintenance Requests</h2>
              <Link
            ...
            {maintenanceRequests.length === 0 ? (
              <div className="text-center py-8">
                <Wrench className="w-12 h-12 text-tx-muted mx-auto mb-3" />
                <p className="text-tx-secondary mb-4">No active maintenance requests</p>
                <Link
                  href="/tenant/maintenance/new"
                ...
                {maintenanceRequests.map((request) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <h3 className="font-medium text-tx-primary">{request.title}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          ...
          >
            ...
            <h3 className="font-semibold text-tx-primary mb-1">Make Payment</h3>
            <p className="text-sm text-tx-secondary">Pay your rent and utilities</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-semibold text-tx-primary mb-1">Request Maintenance</h3>
            <p className="text-sm text-tx-secondary">Report issues in your unit</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-semibold text-tx-primary mb-1">My Profile</h3>
            <p className="text-sm text-tx-secondary">View lease and unit details</p>
          </Link>
        </div>
      </div>
    </div>
