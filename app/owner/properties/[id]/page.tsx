          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <p className="text-sm text-tx-secondary">Country</p>
                  <p className="font-medium text-tx-primary">{property.country}</p>
                </div>
              </div>
            ...
            <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
              ...
              {units.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-tx-primary mb-2">No Units Yet</h3>
                  <p className="text-tx-secondary mb-4">Start by adding units to this property</p>
                  <Link
                    href="/owner/units/new"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
                  >
