...
export default function TenantDetailPage() {
    ...
    return (
      <div className="min-h-screen bg-bg-secondary flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-tx-primary mb-2">Tenant Not Found</h2>
          <p className="text-tx-secondary mb-4">The tenant you're looking for doesn't exist.</p>
          <Link
            href="/owner/tenants"
  ...
  const statusColors = {
    ...
    gray: 'bg-bg-secondary text-tx-primary'
  };
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-tx-primary">{tenantUser?.full_name || 'Unknown Tenant'}</h1>
                  <div className="flex items-center gap-2 mt-1">
                    <Home className="w-4 h-4 text-tx-muted" />
                    <span className="text-tx-secondary">{tenant.unit?.unit_number || 'No unit assigned'}</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-tx-primary">{tenantUser?.email || 'N/A'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-tx-primary">{tenantUser?.phone || 'N/A'}</p>
                  </div>
                </div>
              </div>
              ...
              {(tenant as any).emergency_contact_name && (
                <div className="mt-6 pt-6 border-t border-bd">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-tx-primary">{(tenant as any).emergency_contact_name}</p>
                      <p className="text-sm text-tx-secondary">{(tenant as any).emergency_contact_phone}</p>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <p className="text-sm text-tx-secondary">Lease Start</p>
                  <p className="font-medium text-tx-primary">{formatDate(tenant.lease_start)}</p>
                </div>
                <div>
                  <p className="text-sm text-tx-secondary">Lease End</p>
                  <p className="font-medium text-tx-primary">{formatDate(tenant.lease_end)}</p>
                </div>
                <div>
                  <p className="text-sm text-tx-secondary">Monthly Rent</p>
                  <p className="font-bold text-lg text-tx-primary">{formatCurrency(tenant.unit?.rent_amount || 0)}</p>
                </div>
                <div>
                  <p className="text-sm text-tx-secondary">Security Deposit</p>
                  <p className="font-medium text-tx-primary">{formatCurrency((tenant as any).deposit_amount || 0)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
              ...
              {payments.length === 0 ? (
                <div className="text-center py-8">
                  <DollarSign className="w-12 h-12 text-tx-muted mx-auto mb-3" />
                  <p className="text-tx-secondary">No payment records found</p>
                </div>
              ) : (
                  ...
                  {payments.slice(0, 5).map((payment) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-tx-primary capitalize">{payment.payment_type} Payment</p>
                      ...
                      <div className="text-right">
                        <p className="font-bold text-tx-primary">{formatCurrency(payment.amount ?? 0)}</p>
          ...
          <div className="space-y-6">
            {/* Unit Info */}
            <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
              <h2 className="text-lg font-semibold text-tx-primary mb-4">Unit Information</h2>
              {tenant.unit ? (
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-tx-secondary">Unit Number</span>
                    <span className="font-bold text-tx-primary">{tenant.unit.unit_number}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-tx-secondary">Bedrooms</span>
                    <span className="font-medium text-tx-primary">{tenant.unit.bedrooms ?? 0}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-tx-secondary">Bathrooms</span>
                    <span className="font-medium text-tx-primary">{tenant.unit.bathrooms ?? 0}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-tx-secondary">Size</span>
                    <span className="font-medium text-tx-primary">{(tenant.unit as any).square_feet ?? tenant.unit.size_sqm ?? 0} m²</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-tx-secondary">Floor</span>
                    <span className="font-medium text-tx-primary">{(tenant.unit as any).floor ?? 0}</span>
                  </div>
                  <Link
                ...
                <p className="text-tx-secondary">No unit assigned</p>
              )}
            </div>

            {/* Quick Stats */}
            <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
              <h2 className="text-lg font-semibold text-tx-primary mb-4">Payment Summary</h2>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-tx-secondary">Total Paid</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-tx-secondary">Payments Made</span>
                  <span className="font-medium text-tx-primary">{payments.length}</span>
                </div>
              </div>
            </div>
            ...
            {riskScore && (
              <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
                ...
                <div className="flex flex-col items-center mb-6">
                  ...
                  >
                    <span className="text-3xl font-bold text-tx-primary">{riskScore.score}</span>
                  </div>
                  ...
                  {[
                    ...
                    <div key={factor.label}>
                      <div className="flex items-center justify-between text-sm mb-1">
                        <span className="text-tx-secondary">{factor.label}</span>
                        <span className="text-tx-muted text-xs">{factor.value}/100 ({factor.weight})</span>
                      </div>
