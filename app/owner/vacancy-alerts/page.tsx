      ...
      <div className="bg-bg-card shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-tx-primary">Predictive Vacancy Alerts</h1>
              <p className="text-tx-secondary mt-1">Predict which units are likely to become vacant based on tenant behavior</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-tx-secondary text-sm font-medium">Total Monitored</h3>
              <Users className="w-5 h-5 text-blue-600" />
            </div>
            <p className="text-3xl font-bold text-tx-primary">{totalCount}</p>
          </div>
          <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-tx-secondary text-sm font-medium">Critical</h3>
        ...
        {filteredAlerts.length === 0 ? (
          <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-12 text-center">
            <AlertTriangle className="w-16 h-16 text-tx-muted mx-auto mb-4" />
              ...
              <table className="w-full">
                <thead className="bg-bg-secondary border-b border-bd">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-tx-muted uppercase tracking-wider">Est. Days</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-tx-muted uppercase tracking-wider">Vacancy Score</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-tx-muted uppercase tracking-wider">Risk Level</th>
                    <th className="px-6 py-3 text-center text-xs font-medium text-tx-muted uppercase tracking-wider">Lease End</th>
                ...
                <tbody className="divide-y divide-bd">
                  {filteredAlerts.map((alert) => {
                    ...
                    return (
                      <tr key={alert.tenantId} className="hover:bg-bg-hover">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-semibold text-tx-primary w-8">{alert.score}</span>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
