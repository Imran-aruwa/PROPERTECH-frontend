      ...
      <div className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Tenant Risk Scores</h1>
              <p className="text-gray-600 mt-1">Assess tenant reliability based on payment, maintenance, and lease data</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-gray-600 text-sm font-medium">Total Scored</h3>
              <Users className="w-5 h-5 text-blue-600" />
            </div>
            <p className="text-3xl font-bold text-gray-900">{riskScores.length}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-gray-600 text-sm font-medium">Low Risk</h3>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  {filteredScores.map((rs) => {
                    ...
                    return (
                      <tr key={rs.tenantId} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-semibold text-gray-900 w-8">{rs.score}</span>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-600">{rs.factors.paymentHistory}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-600">{rs.factors.latePayments}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-600">{rs.factors.maintenance}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-600">{rs.factors.occupancyDuration}</td>
