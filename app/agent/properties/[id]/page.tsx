...
import {
  ...
  DollarSign, Bed, Bath, Eye, Phone, Mail
} from 'lucide-react';
...
export default function AgentPropertyDetailPage() {
  ...
  const { isLoading: authLoading, isAuthenticated } = useRequireAuth('agent');
    ...
    <div className="min-h-screen bg-bg-secondary">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-tx-secondary text-sm font-medium">Available</h3>
          ...
          <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-tx-secondary text-sm font-medium">Total Rent Potential</h3>
              <DollarSign className="w-5 h-5 text-tx-muted" />
            </div>
            <p className="text-3xl font-bold text-tx-primary">{formatCurrency(totalRent)}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Units List */}
            <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
              <h2 className="text-lg font-semibold text-tx-primary mb-4">Available Units ({availableUnits})</h2>

              {units.length === 0 ? (
                <div className="text-center py-12">
                  <Home className="w-16 h-16 text-tx-muted mx-auto mb-4" />
                  <h3 className="text-lg font-medium text-tx-primary mb-2">No Units Listed</h3>
                  <p className="text-tx-secondary">No units are currently listed for this property</p>
                </div>
              ) : (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {unit.status === 'available' || unit.status === 'vacant' ? (
                          ...
                          <span className="text-sm text-tx-muted">Occupied</span>
                        )}
                      </div>
                    </div>
                  ))}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-bg-card rounded-lg shadow-sm border border-bd p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-tx-secondary">Available Units</span>
                ...
                <div className="pt-3 border-t border-bd">
                  <div className="flex items-center justify-between">
                    <span className="text-tx-secondary">Avg. Rent</span>
