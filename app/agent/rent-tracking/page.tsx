        ...
        <div key={payment.id} className="bg-bg-card rounded-lg border p-4 space-y-3">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-sm text-tx-muted">{payment.property} - Unit {payment.unit}</p>
            </div>
      ...
      <DashboardLayout role="agent">
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-tx-secondary">Loading rent tracking...</p>
          </div>
        </div>
      </DashboardLayout>
    );
    ...
    <DashboardLayout role="agent">
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-tx-primary">Rent Tracking</h1>
            <p className="text-tx-secondary mt-1">Monitor rent collection and your commissions</p>
          </div>
        ...
        {filteredPayments.length === 0 ? (
          <div className="text-center py-12 bg-bg-card rounded-lg border">
            ...
            <p className="text-tx-muted">No payments found</p>
          </div>
        ) : (
          <>
            <MobileCardView />
